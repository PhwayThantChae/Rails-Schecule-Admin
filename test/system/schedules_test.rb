...
class SchedulesTest < ApplicationSystemTestCase
  ...
  test "creating a Schedule" do
    ...
    fill_in "Slide Url", with: @schedule.slide_url
    fill_in "Speaker", with: @schedule.speaker_id
    fill_in "Topic", with: @schedule.topic
    fill_in "Video Url", with: @schedule.video_url
